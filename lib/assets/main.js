export function init(ctx, payload) {
        ...
        <div class="container">
          <div class="row header">
            ...
            <div class="inline-field">
              ...
              <input class="input input--xs input-text" id="channel-id" placeholder="Channel ID">
            </div>
            <div class="inline-field">
          ...
          <div class="help-box" x-cloak x-show="helpBoxOpen">
            <div class="section">
              <p>
                ...
                <a href="https://discord.com/developers/docs/getting-started#creating-an-app" target="_blank">create a Discord app and get your app's token</a>.
              </p>
            </div>
          </div>
          <div class="row">
            <div class="field grow">
              ...
              <textarea id="message" rows="10" class="input input--text-area" placeholder="Insert your Discord message here..."></textarea>
            </div>
          </div>
        </div>
      </form>
  ...
  channelEl.value = payload.fields.channel_id;

  const messageEl = document.getElementById("message");
  messageEl.value = payload.fields.message;

  channelEl.addEventListener("change", (event) => {
    ctx.pushEvent("update_channel_id", event.target.value);
  });
